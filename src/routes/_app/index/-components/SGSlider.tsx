...
const SgSlider = ({ params, title }: { params: Record<string, any>, title: string }) => {
            ...
            <div className="lg:mt-8 mt-5">
                ...
                <div className="mt-3">
                    <Swiper id={title}
                        ...
                        onReachEnd={(swiper) => handleSliderChange(swiper.isBeginning, swiper.isEnd)} // End reached
                        onReachBeginning={(swiper) => handleSliderChange(swiper.isBeginning, swiper.isEnd)} // Beginning reached
                        onSwiper={(swiper) => {
                            if (isSuccess)
